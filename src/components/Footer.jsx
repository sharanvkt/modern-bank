...
const Footer = () => {
  return (
    ...
    <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
      <div className='flex-1  flex flex-col justify-start mr-10'>
        <img src={logo} alt="logo" className='w-[266px] h-[72px] object-contain' />
          <p className={`${styles.paragraph} max-w-[312x] mt-4`}>
    ...
    <div className='w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]'>
      <p src='https://github.com/sharanvkt' className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white cursor-pointer'>
      Made With <span>❤️</span>  By <span >Sharan</span>
      </p>
